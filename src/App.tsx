...
const useStyles = makeStyles({
  ...
  mobileGuideSheet: {
    position: "absolute",
    zIndex: 1,
    left: "clamp(-104px, -24vw, -58px)",
    bottom: "clamp(-12px, -2vw, 0px)",
    width: "clamp(238px, 64vw, 330px)",
    height: "auto",
    display: "block",
    objectFit: "contain",
    opacity: 0.44,
  ...
  mobileHeroArtImage: {
    width: "100%",
    maxHeight: "clamp(260px, 68vw, 324px)",
    objectFit: "contain",
